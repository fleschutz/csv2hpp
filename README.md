...
💡 Hints
--------
* Datatype hints are mapped to C/C++ datatypes as follows: `(skip)` skips the column, `(string) -> const char*`, `(int) -> int`, `(float) -> float`, and so on. All datatype hints are listed in [hints.csv](src/hints.csv)
