// DO NOT EDIT! File converted from supported_hints.csv on 2026-02-19 by csv2hpp 0.5
...
{"","const char* %s;","TEXT","C/C++ datatype to hold a string (when no datatype hint given)"},
...
{"_nm","SI::length %s;","SI","Length in nanometers (using SI lib for C++)"},
{"_mm","SI::length %s;","SI","Length in millimeters (using SI lib for C++)"},
{"_cm","SI::length %s;","SI","Length in centimeters (using SI lib for C++)"},
{"_m","SI::length %s;","SI","Length in meters (using SI lib for C++)"},
{"_km","SI::length %s;","SI","Length in kilometers (using SI lib for C++)"},
{"_au","SI::length %s;","SI","Length in Astronomical Units (using SI lib for C++)"},
{"_pc","SI::length %s;","SI","Length in Parsec (using SI lib for C++)"},
{"_Da","SI::mass %s;","SI","Mass in Daltons (using SI lib for C++)"},
{"_mg","SI::mass %s;","SI","Mass in milligrams (using SI lib for C++)"},
{"_g","SI::mass %s;","SI","Mass in grams (using SI lib for C++)"},
{"_kg","SI::mass %s;","SI","Mass in kilograms (using SI lib for C++)"},
{"_t","SI::mass %s;","SI","Mass in metric tons (using SI lib for C++)"},
{"_ms","SI::time %s;","SI","Time in milliseconds (using SI lib for C++)"},
{"_s","SI::time %s;","SI","Time in seconds (using SI lib for C++)"},
{"_min","SI::time %s;","SI","Time in minutes (using SI lib for C++)"},
{"_h","SI::time %s;","SI","Time in hours (using SI lib for C++)"},
{"_days","SI::time %s;","SI","Time in days (using SI lib for C++)"},
{"_K","SI::temperature %s;","SI","Temperature in Kelvins (using SI lib for C++)"},
{"_degC","SI::temperature %s;","SI","Temperature in °Celsius (using SI lib for C++)"},
{"_degF","SI::temperature %s;","SI","Temperature in °Fahrenheit (using SI lib for C++)"},
{"_bar","SI::pressure %s;","SI","Pressure in bar (using SI lib for C++)"},
{"_mbar","SI::pressure %s;","SI","Pressure in millibars (using SI lib for C++)"},
{"_Hz","SI::frequency %s;","SI","Frequency in Hz (using SI lib for C++)"},
{"_mHz","SI::frequency %s;","SI","Frequency in millihertz (using SI lib for C++)"},
{"_kHz","SI::frequency %s;","SI","Frequency in kilohertz (using SI lib for C++)"},
...
{"_m_per_s","SI::velocity %s;","SI","Velocity in meter per second (using SI lib for C++)"},
{"_km_per_h","SI::velocity %s;","SI","Velocity in kilometer per hour (using SI lib for C++)"},
